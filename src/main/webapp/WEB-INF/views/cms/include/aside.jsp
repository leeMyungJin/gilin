...
<aside class="aside">
    ...
    <ul class="gnb">
        <li><a href="/cms/user"><span class="material-icons-round">groups</span>회원관리</a></li>
        <li><a href="/cms/channel"><span class="material-icons-round">grid_view</span>채널관리</a></li>
        <li><a href="/cms/project"><span class="material-icons-round">article</span>프로젝트관리</a></li>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var gnb_menu = document.querySelectorAll(".gnb li")
        gnb_menu.forEach(function(el, idx) {
            el.classList.remove("active");
        });

        var currentMenu = document.querySelector("a[href='" + path +"']")
