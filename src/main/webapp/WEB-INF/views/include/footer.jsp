...
function moveNotice(){
  ...
  <footer class="footer">
    <div class="inner">
      ...
      <div onClick="moveNotice()" class="info">공지사항</div>
      <div class="sns_wrap">
        <a href=""><img src="../img/blog_icon.svg" alt=""></a>
        <a href=""><img src="../img/insta_icon.svg" alt=""></a>
        <a href=""><img src="../img/band_icon.svg" alt=""></a>
      </div>
      <ul class="info">
        <li>기린</li>
        <li>장기원</li>
        <li>경남 창원시 마산합포구 3·15대로 298 경남대학교 창업보육관</li>
        <li>사업자등록번호 : 485-78-00200</li>
        <li>전화번호 : 010-4922-6789</li>
        <li>이메일 : whitakercompany@naver.com</li>
      </ul>
    </div>
    <div class="copyright">ⓒ 2021. GILIN Co. ALL RIGHTS RESERVED</div>
  </footer>